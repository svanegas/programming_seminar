...
\begin{frame}[fragile]
	\frametitle{Divide!}
	Can be useful that each team divide the problems in 3 sections, \\ 
	each participant will try to find a easy problem in his section, \\
	when nobody can find more easy problems, is time to try to solve a problem together. \\
\end{frame}
\end{subsection}
\end{section}
